...
BlockEvents.rightClicked("society:skull_cavern_teleporter", (e) => {
  ...
  if (level.dimension !== "society:skull_cavern" && !player.stages.has("vault_complete")){
    errorText = Text.translatable("You must complete the Vault Bundle before entering Skull Cavern.").toJson();
  } else {
